...
<body>
    <div class="container pt-4">
        ...
        <div class="container"> 
            <img src="/img/cabecera.png" width="655" height="auto"> 
            @guest
                            @if (Route::has('login')) 
                             <li>
...
<br>
        ...
        <div class="card">
                <a class="btn btn-outline-secondary" href="{{ route('cajas.index') }}">
                    <img src="/img/caja.png" width="200" height="auto" />
                </a>
                <div class="card-body">
                    <center>
            ...
            <div class="card">
                <a class="btn btn-outline-secondary" href="/portada">
                    <img src="/img/rep.png" width="200" height="auto" />
                </a>
                <div class="card-body">
                    <center>
            ...
            <div class="card">
                <a class="btn btn-outline-secondary" href="{{ route('registros.index') }}">
                    <img src="/img/122.png" width="200" height="auto" />
                </a>
                <div class="card-body">
                    <center>
