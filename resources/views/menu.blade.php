        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                    ...
                    <img src="/img/12778.png" width="45" height="auto">
                    {{ Auth::user()->name }}
                </a>
        ...
        <div class="card-group">
            <div class="card">
                <a class="btn btn-outline-secondary" href="{{ route('cajas.index') }}">
                    <img src="/img/caja.png" width="310" height="auto" />
                </a>
                <div class="card-body">
                    <center>
                        <h4> <strong>Cajas</strong></h4>
                        <p class="card-text">En este módulo podras crear, ver y editar cajas, contratos y la información
                            del expediente.</p>
                    </center>
                </div>
            </div>
            <div class="card">
                <a class="btn btn-outline-secondary" href="{{ route('registros.index') }}">
                    <img src="/img/122.png" width="310" height="auto" />
                </a>
                <div class="card-body">
                    <center>
