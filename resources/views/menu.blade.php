...
<body>
    <div class="container pt-0">
        ...
        <div class="container">
            <img src="/img/cabecera.png" width="666" height="auto">
            @guest
                            @if (Route::has('login'))
                             <li>
...
<br>
        ...
        <div class="card">
                <a class="btn btn-outline-secondary" href="{{ route('cajas.index') }}">
                    <img src="/img/caja.png" width="290" height="auto" />
                </a>
                <div class="card-body">
                    <center>
                        <h4> <strong>Cajas</strong></h4>
                        <p class="card-text">En este módulo podras crear, ver y editar cajas, contratos y la información del expediente.</p>
                    </center>
                </div>
            </div>
            <div class="card">
                <a class="btn btn-outline-secondary" href="{{ route('registros.index') }}">
                    <img src="/img/122.png" width="290" height="auto" />
                </a>
                <div class="card-body">
                    <center>
