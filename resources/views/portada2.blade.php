...
<div class="card text-center container">
    <div class="card-header">
        <select class="btn-lg btn btn-outline-light" style="color:rgb(0, 0, 0)">
            ...
            <option>DIRECCIÓN GENERAL DE PROYECTOS, PROGRAMACIÓN Y PRESUPUESTO DE CAMINOS Y CARRETERAS ESTATALES
            </option>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    <h3 class="display-3"> <input class="text-center" style="width:200px" type="text" placeholder=" 0/0"></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="card-footer text-muted">
        <h4> <b> DOCUMENTACION DEL EJERCICIO:</b> <br></h4>
        <input class=" btn-lg btn btn-outline-ligth" type="text" placeholder="Año">
    </div>
</div>
<div class="container">

<a class="btn btn-sm" onclick="javascript:window.print()"><i
